<template lang="html">
  <nav>
    <router-link class="title" :to="{ name: 'Home', params: {} }"
      >ReVue</router-link
    >
    <router-link class="services" :to="{ name: 'service' }"
      >Service</router-link
    >
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        >
        <router-link class="create-subvue" :to="{ name: 'CreateSubvue' }"
          >Create a Subvue</router-link
        >
      </div>
    </div>
    ...
    <a v-if="$store.state.isUserLoggedIn" style="float:right" @click="logout()"
      >Logout</a
    >
    <router-link
      v-if="$store.state.isUserLoggedIn"
